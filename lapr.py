...
# Instalare și import biblioteci necesare
...
# Specifică calea către fișierul JSON de credențiale
...
# Construim matricea de corelație pentru grafic
...
# 1. Interactive Bar Chart - Distribuția Semnalului
...
# 2. Line Chart - Viteza (Speed) în funcție de Oră (Hour)
...
# Date din BigQuery exportate în DataFrame
data = results

# 3. Corelația dintre Viteză și Semnal (Scatter Plot)
plt.figure(figsize=(8, 6))
...
# 4. Evoluția vitezei in funcție de dată (Line Chart folosind Plotly)
...
# Regrupăm și recalculăm proporțiile
...
# 6. Bubble Chart - Relația Dintre Semnal, Viteză și Sateliți
...
# 7. 3D Scatter Plot - Relația Dintre Semnal, Viteză și Precizie
...
# 8. Histogramă - Distribuția Preciziei
...
# 9. Histogramă - Distribuția vitezei
...
# 10. Sunburst Chart - operatori, rețele, activitate
...
# Creăm un grafic interactiv
fig = go.Figure()

# Linia pentru valorile reale (Actual)
...
# Linia pentru valorile prezise (Predicted)
fig.add_trace(go.Scatter(
    x=test_results_sorted.index,
...
# Convertire rezultate în Pandas DataFrame
